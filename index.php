...
<html lang="ru">
    ...
    ?>
        ...
        <div class="container-fluid">
          <div class="row row-cols-3 row-col-lg-2 g-2">
        ...
        ?>    
            <div class="col-12 col-md-4">
              <div class="card" style="width: 25rem; height: 28rem;">
                <form method="get" action="next-article.php" enctype="multipart/form-data">
                    <a class="news text-decoration-none" href="article_1.html">
                        <img class="card-img-top" src="./pics/<?=$article[$j]["CardPicture"]?>" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title"><?=$article[$j]["Title"]?></h5>
                            <p class="card-text"><?=$article[$j]["ShortText"]?></p>
                            <p class="card-footer"><?=$article[$j]["BottomData"]?></p>
                        </div>
                    </a>
                </form>
              </div>
